...
const Info = () => {
    return ( 
        ...
        <section className="BG_white">
            ...
            <p>To be creative is like a relief for me. For when you hold a lot of emotions inside, that you need to get rid of or express. Art is an amazing tool for me.
                That being in my art and drawings or in my web developing, doesn’t matter. One part lets me use the creative side of my brain and the other let’s me use the mathematic side of my brain, stimulating my ADHD and letting me work as a normal person.</p>
        </section>
        ...
        <section>
            <h2>Perks of hiring me</h2>
            <article className="white_box">
                <h3>Hard Working</h3>
